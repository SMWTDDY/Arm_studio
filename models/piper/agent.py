...
from models.base_arm import BaseArm, BaseArmActionWrapper
...
class PiperArm(BaseArm):
    ...
    def _controller_configs(self):
        ...
        gripper_pd = PDJointPosControllerConfig(
            ...
            lower=0.0, upper=0.035, stiffness=500, damping=50, normalize_action=True, drive_mode="force"
        )
        return dict(
